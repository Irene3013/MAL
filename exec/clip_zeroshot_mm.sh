...
srun python main.py --model "clip" \
   --lr 1e-6 --batch_size 200 --max_epochs 10 --accumulate_grad_batches 1 \
   --run_name clip_v7 --evaluate --dataset rel \
   --root /gaueko0/users/ietxarri010/MAL/data/raw/RelationsDataset --precision 32 --variant v7

srun python main.py --model "clip" \
   --lr 1e-6 --batch_size 200 --max_epochs 10 --accumulate_grad_batches 1 \
   --run_name clip_v7 --train --evaluate --dataset rel \
   --root /gaueko0/users/ietxarri010/MAL/data/raw/RelationsDataset --precision 32 --variant v7
...
srun python main.py --model "clip" \
   --lr 1e-6 --batch_size 100 --max_epochs 20 \
   --run_name clip_v7 --train --evaluate --dataset rel --accumulate_grad_batches 2 \
   --root /gaueko0/users/ietxarri010/MAL/data/raw/RelationsDataset --precision 32 --variant v7

srun python main.py --model "clip" \
   --lr 1e-6 --batch_size 50 --max_epochs 20 \
   --run_name clip_v7 --train --evaluate --dataset rel --accumulate_grad_batches 4 \
   --root /gaueko0/users/ietxarri010/MAL/data/raw/RelationsDataset --precision 32 --variant v7

# srun python main.py --model "clip" \
#    --lr 1e-6 --batch_size 100 --max_epochs 20 --accumulate_grad_batches 2 \
...
# srun python main.py --model "clip" \
#    --lr 1e-6 --batch_size 50 --max_epochs 20 --accumulate_grad_batches 4 \
#    --run_name clip_v1 --train --evaluate --dataset rel \
#    --root /gaueko0/users/ietxarri010/MAL/data/raw/RelationsDataset --precision 32 --variant v1
